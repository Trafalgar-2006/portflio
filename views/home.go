...
// Braille portrait — regenerated from the source photo with a hard black
// point, so the background is genuinely empty rather than filled with
// single-dot noise. The previous art was 67%% filler dots and 0%% blanks,
// which is why it read as static instead of a face.
